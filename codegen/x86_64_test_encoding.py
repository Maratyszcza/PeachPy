...
def objcopy(*args):
    ...
    assert objdump_path, "objcopy not found, please set the environment variable OBJCOPY"
...
def gas(*args):
    ...
    assert gas_path, "GNU assembler not found, please set the environment variable GAS"
