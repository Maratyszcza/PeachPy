...
class AssemblyWriter(TextWriter):
    def __init__(self, output_path, assembly_format, input_path=None):
        ...
        if input_path is not None:
            self.prologue = "%s Generated by PeachPy %s from %s" % (self.comment_prefix, peachpy.__version__, input_path)
        else:
            self.prologue = "%s Generated by PeachPy %s" % (self.comment_prefix, peachpy.__version__)
